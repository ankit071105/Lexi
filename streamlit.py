# AIzaSyAETxVxx9E-bicGEjNEsXFaGSnMtleRd00
...
<style>
    ...
    * {
    ...
    .main-header {
        font-size: 3.2rem;
        background: linear-gradient(135deg, #b0d3f4 0%, #234f96 100%) !important;
...
def generate_answer(question, chunks):
    ...
    if not st.session_state.gemini_api_key:
        return {"error": "Please set your Gemini API key in the settings tab."}
...
# Main app tabs
tab1, tab2, tab3, tab4 = st.tabs(["📤 Upload Documents", "❓ Ask Questions", "📊 Document Library", "⚙️ Settings"])
...
with tab4:
    ...
    st.markdown("""
    <div class="info-box">
        <strong>🔒 Secure API Integration:</strong> Your API key is stored only in your current session and never transmitted to our servers.
    </div>
    """, unsafe_allow_html=True)
    ...
    api_key = st.text_input(
        ...
        help="Enter your Google Gemini API key to enable claim analysis"
    )
